 ...
 */
'use strict'
exports[`test/test.js test/fixtures/abbrev-with-other-manifest-types.js TAP > corgi 1`] = `
Object {
  "dist-tags": Object {
    "latest": "1.1.1",
  },
...
exports[`test/test.js test/fixtures/abbrev-with-other-manifest-types.js TAP > object diff 1`] = `
Object {
  "_id": 1,
  "_rev": 1,
  "author": 1,
...
exports[`test/test.js test/fixtures/abbrev-with-other-manifest-types.js TAP > version diff 1`] = `
Object {
  "_from": 5,
  "_id": 7,
  "_nodeVersion": 5,
